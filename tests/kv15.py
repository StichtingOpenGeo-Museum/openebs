...
msg = StopMessage(dataownercode='VTN', userstopcodes=['42028501'], messagecontent='GENERAL ENDTIME2')
msg.messagetype = MessageType.GENERAL
msg.mesagedurationtype = MessageDurationType.ENDTIME
msg.messagestarttime = datetime.combine(date.today(), time(XX, 05))
...
msg = StopMessage(dataownercode='VTN', userstopcodes=['42028501'], messagecontent='GENERAL FIRSTVEJO')
msg.messagetype = MessageType.GENERAL
...
msg = StopMessage(dataownercode='VTN', userstopcodes=['42028501'], messagecontent='GENERAL FIRSTVEJO2')
msg.messagetype = MessageType.GENERAL
msg.mesagedurationtype = MessageDurationType.FIRSTVEJO
msg.messagestarttime = datetime.combine(date.today(), time(XX, 05))
kv15 = KV15messages(stopmessages = [msg])
...
msg = StopMessage(dataownercode='VTN', userstopcodes=['42028501'], messagecontent='OVERRULE REMOVE')
...
msg = StopMessage(dataownercode='VTN', userstopcodes=['42028501'], messagecontent='OVERRULE ENDTIME')
msg.messagetype = MessageType.OVERRULE
msg.mesagedurationtype = MessageDurationType.ENDTIME
msg.messagestarttime = datetime.combine(date.today(), time(XX, 05))
...
msg = StopMessage(dataownercode='VTN', userstopcodes=['42028501'], messagecontent='OVERRULE ENDTIME2')
msg.messagetype = MessageType.OVERRULE
msg.mesagedurationtype = MessageDurationType.ENDTIME
msg.messagestarttime = datetime.combine(date.today(), time(XX, 05))
...
msg = StopMessage(dataownercode='VTN', userstopcodes=['42028501'], messagecontent='OVERRULE FIRSTVEJO')
msg.messagetype = MessageType.OVERRULE
msg.mesagedurationtype = MessageDurationType.FIRSTVEJO
msg.messagestarttime = datetime.combine(date.today(), time(XX, 05))
...
msg = StopMessage(dataownercode='VTN', userstopcodes=['42028501'], messagecontent='OVERRULE FIRSTVEJO2')
msg.messagetype = MessageType.OVERRULE
msg.mesagedurationtype = MessageDurationType.FIRSTVEJO
msg.messagestarttime = datetime.combine(date.today(), time(XX, 05))
kv15 = KV15messages(stopmessages = [msg])
...
# Delete bij gezet omdat anders de andere testen falen
waitforit(datetime.combine(date.today(), time(YY, 38)))
delmsg = msg.delete()
kv15 = KV15messages(stopmessages = [delmsg])
kv15.push(remote, '/TMI_Post/KV15')
...
msg = StopMessage(dataownercode='VTN', userstopcodes=['42028501'], messagecontent='Deze aanbieder adviseert over en ontwikkelt, beheert en onderhoudt informatiesystemen voor mobiliteit. Als specialist in multi-modaal verkeer en vervoer zet zij haar kennis en ervaring in voor het hele traject van systeemontwikkeling en -onderhoud.')
msg.messagetype = MessageType.GENERAL
msg.mesagedurationtype = MessageDurationType.REMOVE
msg.messagestarttime = datetime.combine(date.today(), time(XX, 05))
kv15 = KV15messages(stopmessages = [msg])
